...
from mistk_test_harness.client.models.service_error import ServiceError  # noqa: E501
...
class TestServiceError(unittest.TestCase):
    ...
    def testServiceError(self):
        ...
        # model = mistk_test_harness.client.models.service_error.ServiceError()  # noqa: E501
        pass
