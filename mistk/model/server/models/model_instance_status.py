...
class ModelInstanceStatus(Model):
    ...
    def __init__(self, object_info: ObjectInfo=None, state: str=None, payload: object=None):  # noqa: E501
        """ModelInstanceStatus - a model defined in Swagger

        :param object_info: The object_info of this ModelInstanceStatus.  # noqa: E501
        :type object_info: ObjectInfo
        :param state: The state of this ModelInstanceStatus.  # noqa: E501
        :type state: str
        :param payload: The payload of this ModelInstanceStatus.  # noqa: E501
        :type payload: object
        """
        self.swagger_types = {
    ...
    def object_info(self) -> ObjectInfo:
        ...
        :return: The object_info of this ModelInstanceStatus.
        :rtype: ObjectInfo
        """
    ...
    def object_info(self, object_info: ObjectInfo):
        """Sets the object_info of this ModelInstanceStatus.


        :param object_info: The object_info of this ModelInstanceStatus.
        :type object_info: ObjectInfo
        """
    ...
    def state(self) -> str:
        ...
        :return: The state of this ModelInstanceStatus.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state: str):
        """Sets the state of this ModelInstanceStatus.

        The current state of the model  # noqa: E501

        :param state: The state of this ModelInstanceStatus.
        :type state: str
        """
    ...
    def payload(self) -> object:
        ...
        :return: The payload of this ModelInstanceStatus.
        :rtype: object
        """
    ...
    def payload(self, payload: object):
        """Sets the payload of this ModelInstanceStatus.

        Additional arbitrary information relevant to the current state.   # noqa: E501

        :param payload: The payload of this ModelInstanceStatus.
        :type payload: object
        """
