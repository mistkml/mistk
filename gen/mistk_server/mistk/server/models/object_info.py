...
class ObjectInfo(Model):
    ...
    def __init__(self, kind: str=None, id: str=None, name: str=None, description: str=None, summary: str=None, owner: str=None, labels: object=None, resources: List[str]=None, resource_version: int=None, creation_time: datetime=None, modification_time: datetime=None):  # noqa: E501
