...
from mistk.server.models.mistk_dataset import MistkDataset  # noqa: E501
from mistk.server.models.model_instance_init_params import ModelInstanceInitParams  # noqa: E501
from mistk.server.models.model_instance_status import ModelInstanceStatus  # noqa: E501
from mistk.server.models.service_error import ServiceError  # noqa: E501
...
def load_data(datasets):  # noqa: E501
    ...
    :param datasets: A dictionary mapping objectives to Object References of Dataset objects.  Dictionary keys must be one of the following {train, test} 
    :type datasets: 
...
def save_predictions(dataset):  # noqa: E501
    """Save the model&#39;s predictions

    Instructs the container to save the predictions to the specified path  # noqa: E501

    :param dataset: A dataset that contains a path pointing to the directory where the predictions are to be saved. 
    :type dataset: dict | bytes

    :rtype: None
    """
    if connexion.request.is_json:
        dataset = MistkDataset.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
