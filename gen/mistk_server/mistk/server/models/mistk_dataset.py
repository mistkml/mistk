...
from mistk.server.models.dataset import Dataset  # noqa: F401,E501
from mistk.server.models.dataset_statistics import DatasetStatistics  # noqa: F401,E501
...
class MistkDataset(Model):
    ...
    def __init__(self, object_info: ObjectInfo=None, datastash_id: str=None, datastash_sub_dir: str=None, modality: str=None, format: str=None, statistics: DatasetStatistics=None, data_path: str=None):  # noqa: E501
