...
_orchestrator_states = {'uninitialized', 'failed', 'initializing', 'waiting_for_agents',
                        ...
                        'completed_episode', 'stopping_episode', 'resetting',
...
class AbstractOrchestrator (metaclass=ABCMeta):
    ...
    def __init__(self):
        ...
        self._machine.add_transition(trigger='completed_episode', source='running', dest='completed_episode')
        ...
        # Objects to store agent information
        self._agents = {}
        self._agents_registered = 0
        self._agents_needed = 0  # TODO: Need to populate this in do_initialize
        self._steps = 10  # TODO: Need to populate this in do_initialize
    ...
    def initialize(self, objectives, props, hparams):
        ...
        :param objectives: The objectives of this orchestrator.
    ...
    def register_agent(self, agent_name, agent_url):
        """
    ...
    def _do_initialize(self, objectives: list, props: dict, hparams: dict):
        ...
        try:  # Initializes the orchestrator
            ...
            # TODO self._agents_needed = something
        except Exception as ex: #pylint: disable=broad-except
            logger.exception("Error initializing the Orchestrator in _do_initalize")
            self.fail(str(ex))

        # TODO: Set something like self.env = NotImplemented
    ...
    def _do_register_agent(self, agent_name: str, agent_url: str):
        ...
        try:  # Try to find the agent object
            ...
            logger.exception(f"Agent could not be found by _do_register_agent")
            self.fail(str(ex))

        try:  # Registers the agent against this orchestrator
            agent_client.agent_registered(agent_cfg={'name': agent_name, 'url': agent_url})
