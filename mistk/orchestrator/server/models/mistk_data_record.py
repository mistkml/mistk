...
from mistk.orchestrator.server.models.data_record import DataRecord  # noqa: F401,E501
from mistk.orchestrator.server import util


class MistkDataRecord(Model):
    ...
    def __init__(self, record_id: str=None, reference_set_project: str=None, referenced_set_id: str=None, values: List[object]=None):  # noqa: E501
        """MistkDataRecord - a model defined in Swagger

        :param record_id: The record_id of this MistkDataRecord.  # noqa: E501
        :type record_id: str
        :param reference_set_project: The reference_set_project of this MistkDataRecord.  # noqa: E501
        :type reference_set_project: str
        :param referenced_set_id: The referenced_set_id of this MistkDataRecord.  # noqa: E501
        :type referenced_set_id: str
        :param values: The values of this MistkDataRecord.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'MistkDataRecord':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The MistkDataRecord of this MistkDataRecord.  # noqa: E501
        :rtype: MistkDataRecord
        """
    ...
    def record_id(self) -> str:
        ...
        :return: The record_id of this MistkDataRecord.
        :rtype: str
        """
    ...
    def record_id(self, record_id: str):
        """Sets the record_id of this MistkDataRecord.

        The id of this record  # noqa: E501

        :param record_id: The record_id of this MistkDataRecord.
        :type record_id: str
        """
    ...
    def reference_set_project(self) -> str:
        ...
        :return: The reference_set_project of this MistkDataRecord.
        :rtype: str
        """
    ...
    def reference_set_project(self, reference_set_project: str):
        """Sets the reference_set_project of this MistkDataRecord.

        the project associated with the data record set   # noqa: E501

        :param reference_set_project: The reference_set_project of this MistkDataRecord.
        :type reference_set_project: str
        """
    ...
    def referenced_set_id(self) -> str:
        ...
        :return: The referenced_set_id of this MistkDataRecord.
        :rtype: str
        """
    ...
    def referenced_set_id(self, referenced_set_id: str):
        """Sets the referenced_set_id of this MistkDataRecord.

        The UUID of the Data Record Set this record is associated with. This  should be the ObjectId of a GroundTruthSet or PredictionSet   # noqa: E501

        :param referenced_set_id: The referenced_set_id of this MistkDataRecord.
        :type referenced_set_id: str
        """
    ...
    def values(self) -> List[object]:
        ...
        :return: The values of this MistkDataRecord.
        :rtype: List[object]
        """
        return self._values
    ...
    def values(self, values: List[object]):
        """Sets the values of this MistkDataRecord.

        A list of labels, optionally this could be a list of dictionaries instead where  the dictionaries contain the ground truth label plus a bounding box, etc,  this could also include certainty assessments.    # noqa: E501

        :param values: The values of this MistkDataRecord.
        :type values: List[object]
        """
