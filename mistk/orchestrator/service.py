...
class OrchestratorInstanceEndpoint():
    ...
    def register_agent(self, agentName, agentUrl):
        """
        Creates & returns a Task which registers an agent to the orchestrator

        :param agent_name: The name of the agent
        :param agent_url: The URL to the agent object
        :return: The created Task object
        """
    ...
    def add_task(self, task):
        ...
        try:
            ...
            ops = ['initialize', 'load_data', 'build_orchestrator', 'register_agent', 'pause',
                   'unpause', 'start_episode', 'stop_episode',
                   'reset']
